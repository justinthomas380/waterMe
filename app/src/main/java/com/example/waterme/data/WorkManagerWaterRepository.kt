...
class WorkManagerWaterRepository(context: Context) : WaterRepository {
    ...
    override fun scheduleReminder(duration: Long, unit: TimeUnit, plantName: String) {
        ...
        * The data needs to consist of a single string value where WaterReminderWorker.nameKey
        * is the key and the plantName passed into scheduleReminder() is the value.
        */
        ...
        * Use the duration and unit passed into the scheduleReminder() function and set the
